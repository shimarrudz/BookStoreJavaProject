...
import br.com.fiap.domain.repository.PessoaJuridicaRepository;
    ...
    public static PessoaJuridicaService of(String persistenceUnit) {
        ...
        synchronized (PessoaJuridicaService.class) {
            if (Objects.isNull( instance )) {
                ...
                PessoaJuridicaRepository pessoaRepository = PessoaJuridicaRepository.of( factory.createEntityManager() );
